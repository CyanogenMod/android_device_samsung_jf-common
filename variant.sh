...
if [[ "$CMDLINE" != "${CMDLINE/SGH-I337_ATT}" ]]; #jflteatt
    then
       ...
       sed -i 's|ro.cm.device=jflte|ro.cm.device=jflteatt|g' /system/build.prop
    ...
    then
       ...
       sed -i 's|ro.cm.device=jflte|ro.cm.device=jfltecan|g' /system/build.prop
       cp -R /system/blobs/gsm/* /system/
    ...
    then
       ...
       sed -i 's|ro.cm.device=jflte|ro.cm.device=jfltecri|g' /system/build.prop
    ...
    then
       ...
       sed -i 's|ro.cm.device=jflte|ro.cm.device=jfltecsp|g' /system/build.prop
       cp -R /system/blobs/cdma/* /system/
    ...
    then
       ...
       sed -i 's|ro.cm.device=jflte|ro.cm.device=jfltespr|g' /system/build.prop
       cp -R /system/blobs/cdma/* /system/
    ...
    then
       ...
       sed -i 's|ro.cm.device=jflte|ro.cm.device=jfltetmo|g' /system/build.prop
       cp -R /system/blobs/gsm/* /system/
    ...
    then
       ...
       sed -i 's|ro.cm.device=jflte|ro.cm.device=jflteusc|g' /system/build.prop
       cp -R /system/blobs/cdma/* /system/
    ...
    then
       ...
       sed -i 's|ro.cm.device=jflte|ro.cm.device=jfltevzw|g' /system/build.prop
       ...
       sed -i 's|ro.cm.device=jflte|ro.cm.device=jfltexx|g' /system/build.prop
       cp -R /system/blobs/gsm/* /system/
fi
