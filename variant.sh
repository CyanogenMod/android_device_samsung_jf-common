...
if [[ $CMDLINE == *SGH-I337M* ]]; #jfltecan
    then
       sed -e 's|ro.build.fingerprint=xxxxxxxxxx|ro.build.fingerprint=samsung/jfltevl/jfltecan:4.2.2/JDQ39/I337MVLUAMDJ:user/release-keys|g' /tmp/build.prop > /tmp/build.prop
       sed -e 's|ro.build.description=xxxxxxxxxx|ro.build.description=jfltevl-user 4.2.2 JDQ39 I337MVLUAMDJ release-keys|g' /tmp/build.prop > /tmp/build.prop
    ...
    then
       sed -e 's|ro.build.fingerprint=xxxxxxxxxx|ro.build.fingerprint=samsung/jflteuc/jflteatt:4.2.2/JDQ39/I337UCUAMDL:user/release-keys|g' /tmp/build.prop > /tmp/build.prop
       sed -e 's|ro.build.description=xxxxxxxxxx|ro.build.description=jflteuc-user 4.2.2 JDQ39 I337UCUAMDL release-keys|g' /tmp/build.prop > /tmp/build.prop
    ...
    then
       sed -e 's|ro.build.fingerprint=xxxxxxxxxx|ro.build.fingerprint=samsung/jfltecri/jfltecri:4.2.2/JDQ39/R970CVVUAME4:user/release-keys|g' /tmp/build.prop > /tmp/build.prop
       sed -e 's|ro.build.description=xxxxxxxxxx|ro.build.description=jfltecri-user 4.2.2 JDQ39 R970CVVUAME4 release-keys|g' /tmp/build.prop > /tmp/build.prop
    ...
    then
       sed -e 's|ro.build.fingerprint=xxxxxxxxxx|ro.build.fingerprint=samsung/jfltecsp/jfltecsp:4.2.2/JDQ39/R970XWWUAMFA:user/release-keys|g' /tmp/build.prop > /tmp/build.prop
       sed -e 's|ro.build.description=xxxxxxxxxx|ro.build.description=jfltecsp-user 4.2.2 JDQ39 R970XWWUAMFA release-keys|g' /tmp/build.prop > /tmp/build.prop
    ...
    then
       sed -e 's|ro.build.fingerprint=xxxxxxxxxx|ro.build.fingerprint=samsung/jfltespr/jfltespr:4.2.2/JDQ39/L720VPUAMDL:user/release-keys|g' /tmp/build.prop > /tmp/build.prop
       sed -e 's|ro.build.description=xxxxxxxxxx|ro.build.description=jfltespr-user 4.2.2 JDQ39 L720VPUAMDL release-keys|g' /tmp/build.prop > /tmp/build.prop
    ...
    then
       sed -e 's|ro.build.fingerprint=xxxxxxxxxx|ro.build.fingerprint=samsung/jfltetmo/jfltetmo:4.3/JSS15J/M919UVUEMK2:user/release-keys|g' /tmp/build.prop > /tmp/build.prop
       sed -e 's|ro.build.description=xxxxxxxxxx|ro.build.description=jfltetmo-user 4.3 JSS15J M919UVUEMK2 release-keys|g' /tmp/build.prop > /tmp/build.prop
    ...
    then
       sed -e 's|ro.build.fingerprint=xxxxxxxxxx|ro.build.fingerprint=samsung/jflteusc/jflteusc:4.2.2/JDQ39/R970VXUAMD9:user/release-keys|g' /tmp/build.prop > /tmp/build.prop
       sed -e 's|ro.build.description=xxxxxxxxxx|ro.build.description=jflteusc-user 4.2.2 JDQ39 R970VXUAMD9 release-keys|g' /tmp/build.prop > /tmp/build.prop
    ...
    then
       sed -e 's|ro.build.fingerprint=xxxxxxxxxx|ro.build.fingerprint=Verizon/jfltevzw/jfltevzw:4.3/JSS15J/I545VRUEMK2:user/release-keys|g' /tmp/build.prop > /tmp/build.prop
       sed -e 's|ro.build.description=xxxxxxxxxx|ro.build.description=jfltevzw-user 4.3 JSS15J I545VRUEMK2 release-keys|g' /tmp/build.prop > /tmp/build.prop
       ...
       sed -e 's|ro.build.fingerprint=xxxxxxxxxx|ro.build.fingerprint=samsung/jfltexx/jflte:4.2.2/JDQ39/I9505XXUAMDE:user/release-keys|g' /tmp/build.prop > /tmp/build.prop
       sed -e 's|ro.build.description=xxxxxxxxxx|ro.build.description=jfltexx-user 4.2.2 JDQ39 I9505XXUAMDE release-keys|g' /tmp/build.prop > /tmp/build.prop
