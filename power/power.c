...
static void configure_governor()
{
    ...
    if (strncmp(governor, "ondemand", 8) == 0) {
        ...
        sysfs_write("/sys/devices/system/cpu/cpufreq/interactive/above_hispeed_delay", "30000 1458000:60000");
        ...
        sysfs_write("/sys/devices/system/cpu/cpufreq/interactive/target_loads", "90 810000:85 1026000:90 1458000:95");
